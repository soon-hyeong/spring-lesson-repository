...
public class TestDI {
	public static void main(String[] args) {
		...
		/*
		 * IOC : 필요 객체(의전성)를 생성하는 것이 아니라 스프링 컨테이너로부터 받아온다
		 * getBean()->IOC 개념 중 DL(Dependency Lookup) 즉 의존성을 검색 lookup 을 통해 확보하는 기법이자 디자인패턴
		 */
		// IOC, DL
...
//		tool2.work();
//		// IOC, DL
//		Tool tool3 = (Tool)factory.getBean("poclain");
//		tool3.work();
